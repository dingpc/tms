...
<body>
	<div class="container">
		<h3 class="dpc-header dpc-smaller dpc-lighter dpc-blue">新增值班信息</h3>
		<form class="form-horizontal" id="dataForm" name="dataForm" action="/dailyinfo/save" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="shiftUser" name="shiftUser" data-verify="vtype:['notempty',{'maxLength':40}]">
				</div>
			</div>
			<div class="form-group">
