...
<body>
	<div class="container">
		<h3 class="dpc-header dpc-smaller dpc-lighter dpc-blue">新增用户</h3>
		<form class="form-horizontal" id="dataForm" name="dataForm" action="/sysuser/save" method="post">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="userName" name="userName" data-verify="vtype:['notempty',{'maxLength':10},'d_english_u']">
				</div>
			</div>
			<div class="form-group">
				<label for="姓名" class="col-sm-2 control-label">姓名</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="realName" name="realName" data-verify="vtype:['notempty',{'maxLength':10}]">
				</div>
			</div>
			<div class="form-group">
				<label for="密码" class="col-sm-2 control-label">密码</label>
				<div class="col-sm-5">
					<input type="password" class="form-control" id="password" name="password" data-verify="vtype:['notempty',{'maxLength':10, 'minLength':4},'d_english']">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="mobile" name="mobile" data-verify="vtype:['mobile']">
				</div>
			</div>
			<div class="form-group">
				<label for="邮箱" class="col-sm-2 control-label">邮箱</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="email" name="email" data-verify="vtype:['email']">
				</div>
			</div>
			<div class="form-group">
