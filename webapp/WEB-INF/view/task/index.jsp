	...
	<div class="container-fluid"  id="bodyDiv">
      <div class="row" id="rowDiv">
        <div class="col-md-2" id="leftDiv">
			<iframe id="leftFrame" name="leftFrame" width="100%" height="100%" frameborder="0" scrolling="yes" src="/task/left"></iframe>          
        </div>
        <div class="col-md-10" id="rightDiv">
          	<iframe id="rightFrame" name="rightFrame" width="100%" height="100%" frameborder="0" scrolling="yes" src="/task/list"></iframe>
        </div>
      </div>
    </div>
</body>
