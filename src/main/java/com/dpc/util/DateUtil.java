...
//			throw new ParseException(pe.getMessage(), pe.getErrorOffset());
	...
	public static String getWeek(String sdate, String num, String dateFormat) {
		Date dd = convertStringToDate(dateFormat, sdate);
	...
	public static Date getYesterdayDate() {
		...
		SimpleDateFormat formatter = new SimpleDateFormat(ConstantUtil.PATTERN_DATE);
		String yesterdayFormat = formatter.format(calendar.getTime());
		return convertStringToDate(ConstantUtil.PATTERN_DATE, yesterdayFormat);
	}
}
